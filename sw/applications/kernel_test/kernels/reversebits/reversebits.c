...
/****************************************************************************/
    ...
    volatile static uint32_t	i_index_cgra    __attribute__((section(".cgra_vars"), aligned(4)));
    volatile static uint32_t	i_NumBits_cgra  __attribute__((section(".cgra_vars"), aligned(4)));
    volatile static uint32_t	o_ret_cgra      __attribute__((section(".cgra_vars"), aligned(4)));
